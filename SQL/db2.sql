...
INSERT INTO `formulario_evidencia` VALUES (1,'Vi al cabro haciendo algo bacán','2018-12-26 12:45:30',NULL,'Cabro haciendo algo bacán','video',1),(6,'Vi al cabro haciendo algo fome','2018-12-26 12:45:30',NULL,'Cabro haciendo algo fome','photo',1),(7,'Vi al cabro haciendo nada','2018-12-26 12:45:30',NULL,'Cabro haciendo nada','video',1),(8,'Vi al cabro haciendo nada','2018-12-26 12:45:30',NULL,'Cabro haciendo nada','video',1);
...
INSERT INTO `profesor` VALUES (1,'Cecilia','Maturana','Ibaceta','cecilia.maturana.ibaceta@gmail.com','Qt5i8i3Mk2U3P1fbo1djhV8bHB73','profesor'),(2,'Ariel','Tirado','Maturana','ariel.tirado@usach.cl','Qt5i8i3Mk2U3P1fbo1djhV8bHB74',NULL);
...
INSERT INTO `profesor_cursos` VALUES (1,1),(3,1),(3,2);
/*!40000 ALTER TABLE `profesor_cursos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `profesor_unidades`
--

DROP TABLE IF EXISTS `profesor_unidades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `profesor_unidades` (
  `unidad_id` bigint(20) NOT NULL,
  `profesor_id` bigint(20) NOT NULL,
  PRIMARY KEY (`unidad_id`,`profesor_id`),
  KEY `FK8ty3j0ron4yqq2230dgybh9lw` (`profesor_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `profesor_unidades`
--

LOCK TABLES `profesor_unidades` WRITE;
/*!40000 ALTER TABLE `profesor_unidades` DISABLE KEYS */;
INSERT INTO `profesor_unidades` VALUES (1,1),(2,1),(3,1);
/*!40000 ALTER TABLE `profesor_unidades` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `reporte` VALUES (1,'Maria Cecilia Maturana','Primer reporte sobre pedrito',1,'asunto del reporte',NULL),(2,'Maria Cecilia Maturana','Primer reporte y lo quiero describir',1,'Asunto del reporte',NULL),(3,'Maria Cecilia Maturana','Primer reporte y lo quiero describir',1,'Asunto del reporte',NULL);
...
-- Dump completed on 2019-04-08  1:14:49
